...
- (BOOL)configureSocketAndReturnError:(NSError **)errPtr
{
	...
	if([theDelegate respondsToSelector:@selector(onSocketWillConnect:)]&& theDelegate != nil)
	{
...
- (void)doAcceptFromSocket:(CFSocketRef)parentSocket withNewNativeSocket:(CFSocketNativeHandle)newNativeSocket
{
	if(newNativeSocket)
	{
		...
		if ([theDelegate respondsToSelector:@selector(onSocket:didAcceptNewSocket:)]&& theDelegate != nil)
			[theDelegate onSocket:self didAcceptNewSocket:newSocket];
		
		newSocket->theFlags |= kDidStartDelegate;
		
		NSRunLoop *runLoop = nil;
		if ([theDelegate respondsToSelector:@selector(onSocket:wantsRunLoopForNewSocket:)]&& theDelegate != nil)
		{
...
- (void)doStreamOpen
{
	if ((theFlags & kDidCompleteOpenForRead) && (theFlags & kDidCompleteOpenForWrite))
	{
		...
		if ([theDelegate respondsToSelector:@selector(onSocket:didConnectToHost:port:)]&& theDelegate != nil)
		{
...
- (void)closeWithError:(NSError *)err
{
	...
	if (theFlags & kDidStartDelegate)
	{
		...
		if ([theDelegate respondsToSelector:@selector(onSocket:willDisconnectWithError:)]&& theDelegate != nil)
		{
...
- (void)close
{
	...
	{
		if ([theDelegate respondsToSelector: @selector(onSocketDidDisconnect:)]&& theDelegate != nil)
		{
...
- (void)doBytesAvailable
{
	...
	if((theCurrentRead != nil) && (theReadStream != NULL))
	{
		...
		else if(totalBytesRead > 0)
		{
			...
			if ([theDelegate respondsToSelector:@selector(onSocket:didReadPartialDataOfLength:tag:)]&& theDelegate != nil)
			{
...
- (void)completeCurrentRead
{
	...
	if([theDelegate respondsToSelector:@selector(onSocket:didReadData:withTag:)] && theDelegate != nil)
	{
...
- (void)doReadTimeout:(NSTimer *)timer
{
	...
	if([theDelegate respondsToSelector:@selector(onSocket:shouldTimeoutReadWithTag:elapsed:bytesDone:)] && theDelegate != nil)
	{
...
- (void)doSendBytes
{
	if((theCurrentWrite != nil) && (theWriteStream != NULL))
	{
		...
		else
		{
			...
			if ([theDelegate respondsToSelector:@selector(onSocket:didWritePartialDataOfLength:tag:)]&& theDelegate != nil)
			{
...
- (void)completeCurrentWrite
{
	...
	if ([theDelegate respondsToSelector:@selector(onSocket:didWriteDataWithTag:)]&& theDelegate != nil)
	{
...
- (void)doWriteTimeout:(NSTimer *)timer
{
	...
	if([theDelegate respondsToSelector:@selector(onSocket:shouldTimeoutWriteWithTag:elapsed:bytesDone:)&& theDelegate != nil])
	{
...
- (void)onTLSHandshakeSuccessful
{
	if((theFlags & kStartingReadTLS) && (theFlags & kStartingWriteTLS))
	{
		...
		if([theDelegate respondsToSelector:@selector(onSocketDidSecure:)]&& theDelegate != nil)
		{
